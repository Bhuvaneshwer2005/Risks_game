...
//
// This file is a frozen copy of src/game/mapData.ts for the Edge Function
// bundle (Deno can't import across the project root the way the Vite build
// can) - keep the two in sync by hand if the board data ever changes.
